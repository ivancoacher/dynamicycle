---
id: 115005250468
title: "Understanding why some preview emails go to spam"
...
Learn about some potential reasons why you may see Klaviyo preview emails land in your spam folder.

## Preview email limits

When sending a preview email, you have the ability to send it directly to an email address. This makes it easier for spammers to abuse this feature. In order to protect all of our customers, Klaviyo imposes sending limits on preview emails. Learn about [preview emails and limits](https://help.klaviyo.com/hc/en-us/articles/115005081907).

If you have reached your email sending limit, you can still preview your emails directly within the template instead, or create a preview list and [send them a campaign](https://help.klaviyo.com/hc/en-us/articles/115005054847).

When sending preview emails, make sure that your test content looks as much like your real campaign as possible. If you use filler words or filler content, then this may trigger the email client’s spam filter. To ensure that your email content doesn't trigger spam filters, you can choose to use a third-party service like [Litmus](https://litmus.com/) to confirm that your emails are passing basic spam filter tests.
...
If you believe your emails are being marked as spam due to from address/reply-to value issues, consider sending your preview emails using the template editor as described [below](#h_011bd7e2-5312-4ae1-b937-ef506ec46ee8).
...
You have the option within Klaviyo to use the [template editor](https://klaviyo.zendesk.com/hc/en-us/articles/4407911841435) as a way to preview emails. Instead of being sent from your email address, these preview emails are sent from Klaviyo.
...
- [How to preview and send test emails in Klaviyo](https://klaviyo.zendesk.com/hc/en-us/articles/115005081907)
- [Understanding Gmail's tabbed inbox](https://help.klaviyo.com/hc/en-us/articles/115005078307)
