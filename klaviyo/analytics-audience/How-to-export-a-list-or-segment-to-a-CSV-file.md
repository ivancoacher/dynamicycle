---
id: 115005078687
title: "How to export a list or segment to a CSV file"
source_url: "https://klaviyo.zendesk.com/hc/en-us/articles/115005078687-How-to-export-a-list-or-segment-to-a-CSV-file"
...
Learn how to export any list or segment in Klaviyo to a CSV file.

Only Klaviyo users with the [Owner, Admin, or Analyst roles](https://help.klaviyo.com/hc/en-us/articles/115005231648) have the ability to export lists or segments.

## Export your list or segment

1. Navigate to ****Audience >********Lists & segments**** tab.
2. Click into the list or segment of your choice. (If you want to export everyone in your account, [create a segment containing all profiles](https://klaviyo.zendesk.com/hc/en-us/articles/115005246168) first.)
3. Select the ****Manage list**** or ****Manage segment**** dropdown.
4. Choose ****Export list to CSV**** or ****Export segment to CSV****.

   - If you do not see this option, it means your role doesn't have the correct permissions to do so; only Owner, Admin, and Analyst users can export lists and segments.![In a Klaviyo segment, the Manage segment menu is open with the Export segment to CSV option highlighted](https://klaviyo.zendesk.com/hc/article_attachments/32574248263195)
5. Choose whether you to export all [properties](https://klaviyo.zendesk.com/hc/en-us/articles/115005074627) associated with your contacts' profiles, or just specific ones.
...
![](https://fast.wistia.com/embed/medias/1b92ma8erl/swatch)
