---
id: 4404257318043
title: "How to add side images in sign-up forms"
...
![An example form with a left side image.](https://klaviyo.zendesk.com/hc/article_attachments/28722558435739)
...
3. In the **Styles** section, navigate to the ****Side Image**** section and select the side where you'd like to add an image (left or right).
   ![The Side Image section of the Styles tab showing an example form's side image set to display on the Right.](https://klaviyo.zendesk.com/hc/article_attachments/28722596850587)
...
![The Upload an image menu that shows when you click the empty image placeholder where you can click Browse Image Library.](https://klaviyo.zendesk.com/hc/article_attachments/28722596855323)
...
![The Show on section of the Styles tab with an example form's side image selected to show on All Devices.](https://klaviyo.zendesk.com/hc/article_attachments/28722596858395)

### Side image styles

Use the **Styles** section of the **Side Image** settings to choose how the image will display.

![The Styles section of the Side Image settings where you can add alt text, set Image Position, choose alignment, and set a background color.](https://klaviyo.zendesk.com/hc/article_attachments/28722596863003)
