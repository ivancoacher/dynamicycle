---
id: 115000798472
title: "How to run a contest or giveaway using subscribe pages"
...
1. Create a dedicated list for contest by navigating to ****Audience > Lists & Segments > Create List / Segment****. Shoppers who fill out the form will add to this list.
   ![the list's and segments tab with the button to create a new list or segment selected](https://klaviyo.zendesk.com/hc/article_attachments/28716051715867)
2. Select ****List****.
3. Name your list and add any tags. Using a name that relates to your contest plans will help you keep organized.
4. Click ****Create list****.
5. Choose to ****Set up a subscribe page****. Subscribe pages have shareable URL's, which make it easy to share a link for your contest in emails and other social channels.
6. A modal will populate informing you that your new list is currently using your account's default consent pages. Click ****Customize for this List**** to create a new set of consent pages for this list.
   ![test1.jpg](https://klaviyo.zendesk.com/hc/article_attachments/28716062126747)
...
7. Under **Subscribe page**, hover over the page name and click ****Edit Page****.
   ![test1.5.jpg](https://klaviyo.zendesk.com/hc/article_attachments/28716062124827)
8. Using the editor, [customize the design and style to match your brand](https://help.klaviyo.com/hc/en-us/articles/115005251848#edit-the-design-of-your-consent-pages4).
9. Recommended: Add a checkbox to indicate whether a registrant accepts marketing or not.
   - Oftentimes, the leads you get from running a contest aren't as high quality as your typical leads, so asking them if they want to receive future emails gives you engagement criteria that you can use to message them later on.
     ![test2.jpg](https://klaviyo.zendesk.com/hc/article_attachments/28716062120731)
   - For example, if someone has the profile property "Accepts Marketing" equals "Yes" on their profile, you can add them to your engaged segment.
     ![example condition showing properties about someone with accepts marketing equals yes](https://klaviyo.zendesk.com/hc/article_attachments/28716051717403)
...
![The Subscribe page URL in the editor's overview menu](https://klaviyo.zendesk.com/hc/article_attachments/28716062122907)
...
![](https://fast.wistia.com/embed/medias/60fkxxpux3/swatch)
...
2. Create a specific welcome series for your contest list
   Create a specific [welcome series flow](https://help.klaviyo.com/hc/en-us/articles/115002775172) for everyone added to your contest/giveaway list that contains 2-3 emails sent over the course of a week. These messages should:
...
3. Add conditions to your engaged main segment
   Do not email contest/giveaway subscribers who did not engage with your welcome series, as this can harm your deliverability. Instead, add the following conditions to your [main segment](https://help.klaviyo.com/hc/en-us/articles/115000200072) to include people who opened or clicked at least one email in your contest-specific welcome series flow.
   ![conditions added to a segment to include people who opened or clicked at least one email in your contest welcome series](https://klaviyo.zendesk.com/hc/article_attachments/28716062115483)

## Additional resources

- - - [Getting started with consent pages](https://help.klaviyo.com/hc/en-us/articles/115005251848)
    - [How to translate consent pages into different languages](https://help.klaviyo.com/hc/en-us/articles/360049498631-How-to-translate-consent-pages-into-different-languages)
    - [How to custom code consent pages](https://help.klaviyo.com/hc/en-us/articles/115000798472)