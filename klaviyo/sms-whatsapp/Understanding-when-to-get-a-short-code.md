---
id: 14476797072795
title: "Understanding when to get a short code"
...
- ****Less carrier filtering****Since short codes require pre-approval, carriers trust messages from short codes more than other number types. If you have “risky” content (e.g., mentions of money), carriers will be more lenient with short codes and less likely to filter your texts.
- ****Brand recognition****
...
## When to consider getting a short code
...
[MMS throughput](https://help.klaviyo.com/hc/en-us/articles/6456860853275) works vastly differently from that of SMS. Resourcing for MMS is more limited, as wireless networks simply can't handle the number of MMS like they can for SMS.
...
This not only means that many of your subscribers will get the information late, but can also lead to you accidentally messaging them outside quiet hours, which is a [compliance risk](https://help.klaviyo.com/hc/en-us/articles/7956171032091). Due to this, Klaviyo will only send SMS within 4 hours of a campaign’s send time; any messages that have not been sent within those 4 hours will be canceled.
...
In general, [MMS throughput](https://help.klaviyo.com/hc/en-us/articles/6456860853275) is less than it is for SMS, but toll-free numbers are more limited than short codes in the US. During busy times and holidays, carriers also tend to prioritize MMS messages that come from short codes over ones from toll-free numbers.
...
- Find out more about [SMS sending numbers](https://help.klaviyo.com/hc/en-us/articles/6637671573403)
- Learn more about what you need to get a short code:
  - [US short code checklist](https://help.klaviyo.com/hc/en-us/articles/4404056340507)
  - [Canada short code checklist](https://help.klaviyo.com/hc/en-us/articles/9192208759579)
  - [New Zealand short code checklist](https://help.klaviyo.com/hc/en-us/articles/9610891725723)