---
id: 16576963362715
title: "Understanding Oklahoma's mini-TCPA"
...
Effective November 1, 2022, the state of Oklahoma enacted a new law that is essentially a stricter version of the federal Telephone Consumer Protection Act (TCPA). Oklahoma's new law, [Bill No. 3168](http://webserver1.lsb.state.ok.us/cf_pdf/2021-22%20ENR/hB/HB3168%20ENR.PDF), puts tighter boundaries on who you can send SMS messaging to and when, as well as how many messages a recipient can receive in a certain timeframe.
...
There has been an increase in claims that all sending numbers should be callable. Thus, if your number can't receive calls, consider [forwarding calls to another number](https://help.klaviyo.com/hc/en-us/articles/31963445305371).
...
- Always get express consent, using clear and conspicuous [disclosure language](https://help.klaviyo.com/hc/en-us/articles/11644128409371) anywhere you collect SMS consent.
- Leave [quiet hours for flows](https://help.klaviyo.com/hc/en-us/articles/4408737146651) on for any non-transactional flow.
- Do not send before 8 a.m. or after 8 p.m. (in the recipient’s local time) for any campaign.
- Use [Smart Sending](https://help.klaviyo.com/hc/en-us/articles/115002779311) to limit how many SMS messages a subscriber can receive within 24 hours.
- Add a [call forwarding number](https://help.klaviyo.com/hc/en-us/articles/31963445305371) for your toll-free number.
- Follow other [SMS best practices](https://help.klaviyo.com/hc/en-us/articles/13288640663579).

## Additional resources

- Set up a [call forwarding number](https://help.klaviyo.com/hc/en-us/articles/31963445305371) for your US toll-free number
- See other [SMS compliance basics](https://help.klaviyo.com/hc/en-us/articles/7956171032091)
- [Create disclosure language](https://help.klaviyo.com/hc/en-us/articles/11644128409371) to use anywhere you gather SMS consent