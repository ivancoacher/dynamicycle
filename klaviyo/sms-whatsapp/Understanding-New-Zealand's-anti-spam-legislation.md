---
id: 9621685242267
title: "Understanding New Zealand's anti-spam legislation "
...
Learn about New Zealand’s anti-spam legislation and its message requirements for SMS.

In New Zealand, the sending of SMS and email marketing messages is regulated by the [Unsolicited Electronic Messages Act 2007](https://www.legislation.govt.nz/act/public/2007/0007/latest/DLM405134.html) (**UEMA**). This legislation was designed to protect people from receiving spam or “unsolicited commercial electronic messages.”
...
![Example of checkbox to subscribe to SMS marketing with disclosure language](https://klaviyo.zendesk.com/hc/article_attachments/28713340007067)

It is also recommended to have [double opt-in](https://help.klaviyo.com/hc/en-us/articles/115005251108) enabled as part of the opt-in process, which requires the individual providing consent to confirm their subscription.
...
By default, every text message in Klaviyo going to a New Zealand recipient will include an organizational prefix, contact details, and opt-out instructions so recipients can easily identify your brand and unsubscribe if necessary.

## Best practices

While not explicitly required by UEMA, the following are best practices for sending CEMs in New Zealand:

- When obtaining consent, enable [double opt-in](https://help.klaviyo.com/hc/en-us/articles/115005251108)
- Do not contact end users on do-not-call or [do-not-disturb registries](https://marketing.org.nz/do-not-call-do-not-mail)
- Inform recipients of any charges associated with a CTA if applicable
- Send messages between 9 a.m. and 8 p.m. in the recipients’ local time (for SMS and direct messages); use [quiet hours for flows](https://help.klaviyo.com/hc/en-us/articles/4408737146651) to automatically prevent sending SMS outside of these times
...
- Do not overload recipients with too many messages; for instance, use [Smart Sending](https://help.klaviyo.com/hc/en-us/articles/115002779311) to limit how often someone can receive messages via a certain channel

## Sending to recipients in New Zealand using Klaviyo

When sending to recipients in New Zealand using Klaviyo, it’s important that you also comply with Klaviyo’s [Terms of Service](https://www.klaviyo.com/legal/terms-of-service) and [Acceptable Use Policy](https://www.klaviyo.com/legal/acceptable-use-policy), which, in certain cases, may be more strict than UEMA requirements.