---
id: 40116637850651
title: "How to migrate from another WhatsApp Business Solution Provider to Klaviyo"
source_url: "https://klaviyo.zendesk.com/hc/en-us/articles/40116637850651-How-to-migrate-from-another-WhatsApp-Business-Solution-Provider-to-Klaviyo"
section: "Migrate to Klaviyo"
category: "WhatsApp"
category_slug: "sms-whatsapp"
klaviyo_updated: "2026-04-20T16:50:32Z"
language: en
---

Learn how to migrate from another WhatsApp Business Solution Provider (BSP) to Klaviyo while keeping your WhatsApp Business phone number and account details.

When switching to a new BSP, you migrate your number and keep the following:
...
![](https://fast.wistia.com/embed/medias/p684kcqews/swatch)

## Before you begin

Before you begin migration,

- Make sure you have login access to the Facebook Business Account used with your current BSP. You must use the same Facebook Business Account to set up WhatsApp in Klaviyo to complete the migration.
- You have access to receive a text on your phone number during the set up process.

## Limitations

When migrating your phone number to Klaviyo, keep in mind:

- Test business phone numbers issued by WhatsApp ****cannot be migrated****.
- Migrated numbers can only be registered with ****the Cloud API****.
- Business phone numbers must have an ****approved display name****.
- Numbers with pending display name change requests cannot be migrated.
- Template quality ratings will not transfer.

## Migrate your WhatsApp Business Phone Number to Klaviyo
