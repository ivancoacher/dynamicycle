---
id: 115005255968
title: "How to add a background image to an email template or section"
...
![Template background image](https://klaviyo.zendesk.com/hc/article_attachments/32906838351899)
...
![Section background image settings](https://klaviyo.zendesk.com/hc/article_attachments/32906838354203)
...
## Set a section background image

Once you’ve chosen an image to use, add a new section to your email template.

1. In the section’s ****Styles**** tab, locate the Background section.
2. Click ****+**** to add an image.
   ![Add a section background image](https://klaviyo.zendesk.com/hc/article_attachments/32906838360475)
3. Click ****Browse Image Library****, then upload your image.
4. Once you’ve styled the background image, add content to the section. You can add any block type (e.g., text block, button block, table block) and any number of blocks to your section.
...
1. Open the section’s ****Styles**** tab.
2. Toggle **Section color** on.
3. Choose a color that closely matches the color of the image you chose.
...
1. Navigate to the template’s ****Styles**** tab.
2. Click ****+**** to add an image.
   ![Template background option](https://klaviyo.zendesk.com/hc/article_attachments/32906838364955)
3. Choose an image from your image library or upload a new one.
...
## Inbox support for background images
...
- [Images in emails reference](https://help.klaviyo.com/hc/en-us/articles/115005253688)
- [Dark mode email design best practices](https://help.klaviyo.com/hc/en-us/articles/360049181631)
- Litmus: [Coding HTML email backgrounds](https://www.litmus.com/blog/background-colors-html-email)