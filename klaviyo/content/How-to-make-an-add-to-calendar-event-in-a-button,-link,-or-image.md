---
id: 360043932991
title: "How to make an add to calendar event in a button, link, or image"
...
Before you begin, make sure your calendar is set to ****Public****. To do this:

1. In your Google Calendar, scroll down on the left-side menu to **My calendars**.
2. Hover over the calendar you'd like to share.
3. Click the three dots to the right of the calendar name.
4. Click ****Settings and sharing****.
5. Under **Access permissions for events**, check ****Make available to the public****.

If you do not make the event public, recipients will see the message "Event not found" when they click the link.
...
5. [Follow the steps below](#h_01G4375ZMVEV1Z8NKZ88HTJG3T) to add the link to your template.

![Locate an event sharing link in Google Calendar](https://fast.wistia.com/embed/medias/h145qkf8cq/swatch)
...
5. Once it’s published, drag the item onto your Desktop or a folder so it saves as an .ics file.
   ...
   ![Create a shareable event in Apple Calendar](https://fast.wistia.com/embed/medias/j4sxm6vbkx/swatch)
6. Add your event to your ecommerce site or host it online, following instructions from your site provider.


   ![A calendar event file is hosted using Shopify](https://fast.wistia.com/embed/medias/pokr9kuh62/swatch)
7. Copy the URL for this page.
8. [Follow the steps below](#h_01G4375ZMVEV1Z8NKZ88HTJG3T) to add the link to your template.
...
3. Drag the event from the Outlook Calendar onto your desktop so you have a .ics file.
   ...
   ![A user creates a shareable Outlook event](https://fast.wistia.com/embed/medias/guq4243bfd/swatch)
4. Add your event to your ecommerce site or host it online, following instructions from your site provider.


   ![A calendar file is hosted on Shopify](https://fast.wistia.com/embed/medias/pokr9kuh62/swatch)
5. [Follow the steps below](#h_01G4375ZMVEV1Z8NKZ88HTJG3T) to add the link to your template.
...
2. Add in the event URL as the **URL.**
3. Select ****Save.****

You can create a button for each type of calendar if you are unsure of which one your customers use.

![A Klaviyo email template with button block calendar links](https://klaviyo.zendesk.com/hc/article_attachments/28717986881819)
...
![A Klaviyo image block's settings with the URL set to a Google Calendar event link](https://klaviyo.zendesk.com/hc/article_attachments/28717986879771)
...
![](https://klaviyo.zendesk.com/hc/article_attachments/28717986887323)

## Additional resources

- [How to show or hide template blocks based on dynamic variables](https://help.klaviyo.com/hc/en-us/articles/115005258208)
