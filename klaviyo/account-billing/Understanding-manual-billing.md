---
id: 18745921973915
title: "Understanding manual billing"
...
- Your Klaviyo plans total $2,000 or more per month.
...
Overages are turned on by default. See this section for details on [turning off overages](#h_01HP4FA6CW6KRJGN9TGEX5J9TD).
...
|  |  |  |
| --- | --- | --- |
|  | ****Without the overage setting**** | ****With the overage setting**** |
| Active profiles | ****✔\***** | ****✔**** |
| Email limits | ****✖**** | ****✔**** |
| SMS limits | ****✖**** | ****✔**** |
...
1. Updating the plan does not impact your invoice amount.
2. You can continue to send even if you go over your plan limits.
...
2. Navigate to ****Billing > Preferences****.
   ![Screenshot 2024-02-01 at 10.55.49 AM.jpg](https://klaviyo.zendesk.com/hc/article_attachments/28722599079835)
3. In the **Plan overview** section, uncheck the **Allow extra X to be sent** box for each product where you no longer want overages.
   In the example above, you'd need to need uncheck both the **Allow** **extra emails to be sent** and the **Allow extra SMS messages to be sent** boxes.
4. Click ****Update plan settings**** to save.

### Billing cycles

Note that billing cycles for manually billed customers are not necessarily the same as the plan usage cycle.

### Plan limits and usage cycle
...
You can view your usage under ****Billing > Account usage****. For more information, see our [article on understanding your account usage.](https://help.klaviyo.com/hc/en-us/articles/17543571835675)
...
2. Click ****Billing****.
3. Review the billing **Overview** page to see your:
...
![Example of the billing overview page for an account on contract billing](https://klaviyo.zendesk.com/hc/article_attachments/28722611022747)
...
All manually billed customers are provided with a W9. However, if you don’t have this form, you can [download the W9 form here](https://www.irs.gov/pub/irs-pdf/fw9.pdf).