---
id: 360036456711
title: "Understanding tax with Klaviyo"
...
1. Click the name of your organization in the bottom left corner.
2. Click ****Billing****.
3. Select****Preferences****.
   ![Billing_preferences.png](https://klaviyo.zendesk.com/hc/article_attachments/28720847420955)
...
- Downloading the invoice as a PDF, which includes:
  ...
  - Tax line item (e.g., percentage and total amount charged)
    ![Example of an invoice](https://klaviyo.zendesk.com/hc/article_attachments/28720892545819)
...
1. Navigate to ****Billing****.
2. Click ****Create your plan****.
3. Review the plan page.
   Note: tax is not included in the price per month in the plans, as noted by the disclaimer.
   ![Page to select a new plan in Klaviyo](https://klaviyo.zendesk.com/hc/article_attachments/28720847413787)
4. Click ****Choose Plan****.
5. View the checkout page, where you can see the tax applied for the plan you chose.
   ![The checkout page when you change your plan, showing the sales tax](https://klaviyo.zendesk.com/hc/article_attachments/28720892551195)
6. Click ****Confirm and Pay****to finish changing your plan.
...
Some nonprofits, religious institutions, educational organizations, research facilities, and others are considered tax-exempt. If you believe that your organization should be tax-exempt, you can follow the [instructions for submitting a tax exemption application](https://klaviyo.zendesk.com/hc/en-us/articles/360037472871).
...
If you are required to register for GST, please provide your Australian Business Number (ABN) on your Klaviyo account. If applicable, please refer to our guide on [how to add your ABN](https://help.klaviyo.com/hc/en-us/articles/360056549931).
...
If you do not wish to continue using Klaviyo as a result of this change, you can find out [how to cancel your account](https://help.klaviyo.com/hc/en-us/articles/1260805595309).

## GST and HST in Canada

Klaviyo will start collecting GST and HST in Canada from June 20, 2024.

If you are required to register for GST or HST, please provide your Canada Revenue Agency (CRA) program account number (i.e., “123456789RT0001”) in your Klaviyo account in the Billing Preference page using the tax type “Canada GST/HST.” If applicable, please refer to our [guide on how to add your tax ID](https://help.klaviyo.com/hc/en-us/articles/360056549931).
...
If you are required to register for VAT, please provide your European VAT number in your Klaviyo account. If applicable, please refer to our [guide on how to add your European VAT number](https://help.klaviyo.com/hc/en-us/articles/360056549931).
...
If you are required to register for VAT, please provide your European VAT number in your Klaviyo account. If applicable, please refer to our [guide on how to add your UK VAT number](https://help.klaviyo.com/hc/en-us/articles/360056549931).
...
- [How to find and update your tax ID in Klaviyo](https://help.klaviyo.com/hc/en-us/articles/360056549931)
