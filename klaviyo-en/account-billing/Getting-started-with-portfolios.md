---
id: 24656917054747
title: "Getting started with portfolios"
...
Note that accounts can be connected to more than 1 portfolio at a time. The Owner of an account will receive an email any time their account is added to a portfolio, and they can also [remove themselves from a portfolio](https://help.klaviyo.com/hc/en-us/articles/25185027474971#h_01HWNHEDGQJS57701QJYMYBY9M) at any time.
...
- Multiple brands
- Clients' brands (if you're an agency)

### Who should be in a portfolio?
...
****I'm an agency, can I create my own portfolio?****

Yes, agencies can create their own portfolio, since accounts can be connected to more than 1 portfolio at a time.

If you're an agency, check that you're an Owner or Admin in every account you want to add. We also recommend asking your clients for permission before adding the account to a portfolio.

## Set up a portfolio

There are 2 steps to the setup:

- [Creating the portfolio](#h_01HWDS7R9FS5TWDZT9M1F1CRBM)
- [Mapping your conversion metrics](#h_01HWDS7R9F2SFV7GHMBJ2D9G5B)
  - Note: until you create a metric and map it to a metric in your account, the portfolio dashboard is blank.

### Create the portfolio

1. Check that you’re in an account as either an Owner or Admin.
2. Select your account name in the bottom left corner.
3. Click ****Settings > Organization****.
4. In the **Portfolio** section, click ****Set up your portfolio****.
5. In the modal that appears, select ****Get started****.
6. Fill out the following information:
   1. Portfolio name.
   2. Website link.
   3. Business address.
      ![Portfolio setup wizard, where you can fill out information about your business](https://klaviyo.zendesk.com/hc/article_attachments/28720898748827)
7. Click ****Next****.
8. Select all the accounts you want in the portfolio from the **Available** tab.
   Note: any accounts in the **Unavailable** tab are accounts where you’re a user but not an Owner or Admin.
   ![Adding accounts to a portfolio](https://klaviyo.zendesk.com/hc/article_attachments/28720898754075)
9. Click ****Create****.
...
- Choose aggregated metrics that have similar data associated with them (e.g., create a single portfolio metric for all **Placed Order** events).
  ...
  2. Under the **Portfolio metrics** dropdown, select ****Create new metric****.
  3. Under **Metric name**, select what you want the metric to be called in the portfolio (e.g., **Order value**).
     ![Naming the new portfolio metric](https://klaviyo.zendesk.com/hc/article_attachments/28720898751515)
  4. Choose the type for the metric (e.g., **Monetary Value** for placed orders).

1. Next to each account, pick what metric you want to map to this portfolio metric (e.g., **Placed Order)**.
   ![Selecting the account metrics to map to the portfolio metric](https://klaviyo.zendesk.com/hc/article_attachments/28720904081051)
...
4. Repeat steps 3-8 for all the metrics you want to view in the portfolio.

Once you’ve added at least 1 metric, you can start analyzing your performance across accounts. For more details about these reports, please see our [article on understanding portfolio reporting](https://help.klaviyo.com/hc/en-us/articles/25185047957275).