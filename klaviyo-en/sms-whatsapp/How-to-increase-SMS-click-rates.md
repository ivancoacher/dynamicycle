---
id: 4404565738395
title: "How to increase SMS click rates"
...
1. [Check your link](#h_01G1VFVDH20FF615B0FY2TS32N)
2. [Include a call-to-action](#h_01G1VFVKNCSVB2GVJQ334NV13X)
3. [Follow sending best practices](#h_01G1VFVVJ4W99B5RZMSK3V62PP)
4. [Provide exclusive offers](#h_01G1VFW4B39ZRNACNJZ2D9SX0Z)
5. [Flows: use splits](#h_01G1VG1KRXVSRNSYZVWN1J1Z3N)
6. [Campaigns: send to engaged subscribers and A/B test](#h_01G1VG1W6Y5NBS72A9V178SBA5)
...
![SMS with an exclusive product offer for SMS subscribers](https://klaviyo.zendesk.com/hc/article_attachments/28713338565787)
...
If your flow messages have low click rates, try adding splits to separate those who have engaged with your text messages in the last few weeks from those who haven’t. Then, offer an extra incentive to unengaged customers to encourage conversions. If the flow you’re looking at is an abandoned cart flow, you can also add a link to [auto-apply a coupon at checkout](https://help.klaviyo.com/hc/en-us/articles/360018227032).

![With splits, you can separate those who haven't purchased since starting a flow and send them a coupon](https://klaviyo.zendesk.com/hc/article_attachments/28713338570395)

Splits also allow you to perform A/B tests. Use a [conditional split](https://help.klaviyo.com/hc/en-us/articles/115003872171-) to create a random sample with a 50/50 split, and then test 1 variable at a time. You can test the timing, content, link placement, and more to learn what your audience prefers. Then, apply these learnings to other flow messages and campaigns to see if it produces a similar response. Keep in mind that you’ll have to manually check the results of the test and decide which performs best.

![Conditional split with a 50/50 random split](https://klaviyo.zendesk.com/hc/article_attachments/28713338560923)

### Campaigns: send to engaged subscribers and A/B test

Segmentation is also critical to achieving strong campaign performance. When you first gather SMS subscribers, send messages to everyone on your list. After about 3 to 6 months, use this data to set up your [SMS engagement segments](https://help.klaviyo.com/hc/en-us/articles/360044556071). Then, only send to your engaged SMS subscribers on a regular basis.
