---
id: "360056849631"
title: "How to use Klaviyo email and SMS together"
source_url: "https://help.klaviyo.com/hc/en-us/articles/360056849631-How-to-use-Klaviyo-email-and-SMS-together"
...
[Embed](//fast.wistia.com/embed/iframe/t2ahdjlykd)
...
Email has been around a long time, and most people are familiar with email sending best practices (e.g., don't send spammy messages). There are also fewer laws surrounding email, so you can send a wider range of content, at more times of day, and to more people than with SMS. In general, it's quicker to get up and running with email, as there's a lot less compliance to worry about.
...
Not everyone you send an email to sees your message. A [good open rate for email is typically 20%](https://help.klaviyo.com/hc/en-us/articles/115005247008), meaning the majority of recipients might not see your message.
...
Those who sign up for SMS marketing from your business tend to be more invested in your brand than your average email subscriber. They are almost like your [VIPs](https://help.klaviyo.com/hc/en-us/articles/115005065707), brand enthusiasts who you can cultivate long-lasting relationships with.
...
There are also more things to read up on before you start sending SMS. You can't send too early or late, or you risk breaking quiet hours regulations. Certain [content is also prohibited for SMS](https://klaviyo.zendesk.com/hc/en-us/articles/4401822831771), such as gambling or sex, hate, alcohol, firearms, and tobacco (SHAFT).
...
The best approach for collecting email and SMS consent is through a [multi-step form](https://klaviyo.zendesk.com/hc/en-us/articles/9351341171995).
...
![](https://klaviyo.zendesk.com/hc/article_attachments/34233085637147)
...
- [SMS subscribers segment](https://help.klaviyo.com/hc/en-us/articles/360035800811)
...
- Gender
- Age
- [Location](https://help.klaviyo.com/hc/en-us/articles/115005065887)
- Preference, interest, or hobby

With these and other [advanced segments](https://help.klaviyo.com/hc/en-us/articles/360035312491), you can become more targeted in your messaging and also learn more about your audience.
...
First, let’s discuss sending the [SMS campaign](https://help.klaviyo.com/hc/en-us/articles/360040039971).

1. Go to ****Campaigns > Create**** ****campaign****, and select ****SMS****.
...
![](https://klaviyo.zendesk.com/hc/article_attachments/34233085646747)

Next, create an [email campaign](https://help.klaviyo.com/hc/en-us/articles/115005054847) by:

1. Navigating to ****Campaigns > Create campaign****, and select ****Email****.
...
3. Excluding your SMS subscribers segment.
   - If you don’t exclude this group, anyone with consent for both SMS and email will get the message twice. Further, since SMS subscribers are excluded, you’ll still get an accurate picture of who will receive this campaign.
     ![](https://klaviyo.zendesk.com/hc/article_attachments/34233123415963)

Alternatively, if you create and send your email campaign first, simply click ****Add SMS**** on the confirmation page to generate an SMS campaign. When you create an SMS campaign this way, you have access to combined reporting for the 2 channels to better understand the impact of each.

![Add SMS button.jpg](https://klaviyo.zendesk.com/hc/article_attachments/28720670670107)

Learn more about [how to add an SMS to an email campaign](https://klaviyo.zendesk.com/hc/en-us/articles/9698252682907).

### Flows

When you have a flow with both emails and SMS, it’s important to remember that someone may be consented to both channels.

Rather than placing an SMS and email directly next to each other in a flow, include splits to send anyone consented to SMS down a different path than those who have only subscribed to email.

To avoid sending too many text messages, you shouldn't send an SMS for every email you have. Instead, decide [which channel to prioritize](https://help.klaviyo.com/hc/en-us/articles/19195818382747) for this particular communication.
...
- Learn more about the [differences between SMS and email](https://help.klaviyo.com/hc/en-us/articles/360036972292).
- See how to [promote a new product launch with omnichannel marketing](https://academy.klaviyo.com/en-us/courses/promote-a-new-product-launch-with-omnichannel-marketing/1757893).
- Get guidance for building your SMS program:
