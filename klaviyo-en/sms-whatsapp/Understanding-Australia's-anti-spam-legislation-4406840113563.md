---
id: "4406840113563"
title: "Understanding Australia's anti-spam legislation"
source_url: "https://help.klaviyo.com/hc/en-us/articles/4406840113563-Understanding-Australia-s-anti-spam-legislation"
...
In Australia, the sending of SMS and email marketing messages is regulated by the [Spam Act 2003](https://www.legislation.gov.au/Details/C2016C00614) (Spam Act) and the [Spam Regulations 2021](https://www.legislation.gov.au/Details/F2021L00285). The Spam Act was designed to protect people from receiving spam, or “unsolicited commercial electronic messages.” It applies to the sending of commercial electronic messages (CEMs) and governs who you can send to and what your messages need to include.
...
- Instant messages
  ...
  The 3 main requirements under the Spam Act for sending messages are:
...
There are 2 types of consent: express and inferred. The Spam Act requires express consent in most cases, which means someone must explicity opt in to receiving marketing messages from your organization.
...
Express consent means someone directly gives you permission to send them marketing messages via a certain channel. This means that you cannot send someone a CEM before they expressly tell you to do so.

When someone consents to receive one type of electronic marketing messages, this does not count as permission to send them any other type of CEM. For instance, if you have someone’s consent for email, you can only send them emails; it does not count as permission to send SMS, mobile push, or any other kind of message.
...
- An opt-out mechanism (e.g., an unsubscribe link) that:
  ...
  - Honors the request to unsubscribe within 5 working days
...
- Do not overload recipients with too many messages; for instance, use [Smart Sending](https://klaviyo.zendesk.com/hc/en-us/articles/115002779311) to limit how often someone can receive messages via a certain channel

## Sending to Australian recipients using Klaviyo

When sending to Australian recipients using Klaviyo, it’s important that you also comply with Klaviyo’s [Terms of Service](https://www.klaviyo.com/legal/terms-of-service) and [Acceptable Use Policy](https://www.klaviyo.com/legal/acceptable-use-policy), which, in certain cases, may be more strict than Spam Act requirements.