---
id: "13288640663579"
title: "Basics: SMS best practices"
source_url: "https://help.klaviyo.com/hc/en-us/articles/13288640663579-Basics-SMS-best-practices"
...
1. [Get permission before sending](#h_01GTCRA12B5A9RQZEDRYTA3H8T).
2. [Make your content](#h_01GTCRAEXVBJ738BX9CS159BYF):
   - Relevant
   - Valuable
   - Unique
3. [Keep SMS messages short](#h_01GTCRB502037HE49P0VPBQM3M).
4. [Send SMS regularly and add variety](#h_01GTCRBCH1YHPZPKE6W228MRQD)
5. [Show off your brand](#h_01GTCRBKDT5ZMG1E3CN934HTFN).
6. [Avoid text-speak](#h_01GTCRBZSG200VXPMGK9YG2S2C).
7. [Include a link as a CTA](#h_01GTCRCB3FJH6GRF1J4J26VWY4).
8. [Make it easy to opt out](#h_01GTCRCNY5VFMST0J4P03DFGSW).
9. [Test using MMS and emojis](#h_01HVHFYP9DGSD4Q6KV27ZG2X4F)
10. [Stay compliant](#h_01GTCRD28ZM78RR291VFZBXB5S).
...
You always want to make sure someone has agreed to get marketing text messages from your brand. Simply agreeing to email, general marketing, or even one-time transactional SMS isn’t enough. To learn more, see this article on [collecting SMS subscribers and what counts as consent](https://help.klaviyo.com/hc/en-us/articles/360035056972-).
...
|  |  |  |  |
| --- | --- | --- | --- |
| ****Channel**** | ****Audience**** | ****Time**** | ****Information**** |
| SMS | SMS subscribers | 10:00 a.m. | Early access to release |
| Email | SMS subscribers who didn’t click the earlier message | 1:00 p.m. | Reminder about the release and provide more details about the products |
| Email | Everyone except SMS subscribers | 1:00 p.m. | Generic alert about the release |
...
|  |  |  |
| --- | --- | --- |
| ****Type of message**** | ****How many to send in 1 month**** | ****Audience**** |
| Important announcements (e.g., promotions, new releases, or holiday) | 2 | - All SMS subscribers |
| Early access alerts/last call follow-ups for key announcements | 2 | - Early access: VIPs - Last call: subscribers that didn't buy yet |
| Targeted campaigns to specific segments | 3 | - VIPs - Subscribers who haven't purchased - People who viewed a product or category - Other targeted segments |
| Messages from at least 3 flows | 3+ | Anyone who triggers your:   - Abandoned cart - Browse abandonment - Order update - Review request - Other flows |
...
To make it easy for recipients, we also recommend sending anyone in the US or Canada a [virtual contact card](https://help.klaviyo.com/hc/en-us/articles/8219838827931), which allows them to easily save your number.
...
![Example of an SMS with one abbreviation](https://klaviyo.zendesk.com/hc/article_attachments/28720761461275)
...
Note that we don’t go into detail about each rule mentioned here; for more, check out the [Basics of SMS compliance](https://help.klaviyo.com/hc/en-us/articles/7956171032091).
...
1. Don’t include [SHAFT and prohibited content](https://help.klaviyo.com/hc/en-us/articles/4401822831771).
   1. Note: [alcohol may be allowed with age-gating](https://help.klaviyo.com/hc/en-us/articles/17252552814875) in certain countries.
...
- Find [13 tips for SMS marketing on the Klaviyo blog](https://www.klaviyo.com/blog/sms-marketing-tips)