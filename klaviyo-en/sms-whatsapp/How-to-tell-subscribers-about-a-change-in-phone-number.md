---
id: 4403980438555
title: "How to tell subscribers about a change in phone number"
...
Learn how to properly inform subscribers when you switch your phone number.
...
This is required in some jurisdictions (e.g., in the US, it’s required under [CTIA guidelines](https://www.wmcglobal.com/hubfs/CTIA%20Short%20Code%20Monitoring%20Handbook%20-%20v1.8.pdf)), and is, in general, a best practice. Note that if you’re switching providers, these messages are usually not required when you keep the same [sending number](https://help.klaviyo.com/hc/en-us/articles/6637671573403); however, your previous SMS provider may require you to send these messages.
...
![Example of a final text from an old number before switching](https://klaviyo.zendesk.com/hc/article_attachments/28723522346395)
...
![Example of a first text from a new number](https://klaviyo.zendesk.com/hc/article_attachments/28723544304411)
...
Don't be alarmed if these messages show a higher unsubscribe rate than your other SMS messages. This is expected for any business changing numbers, as it's normal for migration messages to have an opt-out rate of ~2.5%.