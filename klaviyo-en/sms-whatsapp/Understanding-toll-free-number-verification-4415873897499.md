---
id: "4415873897499"
title: "Understanding toll-free number verification"
source_url: "https://help.klaviyo.com/hc/en-us/articles/4415873897499-Understanding-toll-free-number-verification"
...
Learn about toll-free number verification, including what it means to be verified and how this works in Klaviyo.
...
- An “Active” tag will add to the number

We don't recommend sending if your number hasn't been verified. You can set up your flows and forms, but do not turn them live until your number is verified.
...
Not all organizations qualify for toll-free verification, or can send with Klaviyo. For instance, if your business model falls under any of the [prohibited content](https://help.klaviyo.com/hc/en-us/articles/4401822831771) categories, you will not be able to send using Klaviyo.
...
It's not recommended. Wireless carriers heavily filter messages coming from unverified numbers on their networks. We recommend avoid sending until your number has been verified.

If a number has been [rejected for verification](https://help.klaviyo.com/hc/en-us/articles/6196800762779-), carriers will heavily filter messages from this number.
...
This contact will receive all registration updates and alerts.
...
- Company website URL
- Company address (important: must match the address where your business is registered)
- Business type
- Business registration type (important: must be from the country listed in your company address)
- Business registration number

After filling out this information, click ****Next**** to submit your number for verification.

Verification takes around 2–5 business days to complete.
...
- [Design your SMS forms](https://help.klaviyo.com/hc/en-us/articles/9351341171995)
- [Create an SMS welcome series](https://help.klaviyo.com/hc/en-us/articles/360036122291)
- [Add SMS to your abandoned cart flow](https://help.klaviyo.com/hc/en-us/articles/115002779411)

Note that you should get your account ready for SMS, you should not turn your forms or flows live until your number is verified.

## What to do if your number is rejected

Your number can be rejected for a number of reasons, most are easily fixable. More information:

- [Understanding toll-free number rejection](https://help.klaviyo.com/hc/en-us/articles/6196800762779)