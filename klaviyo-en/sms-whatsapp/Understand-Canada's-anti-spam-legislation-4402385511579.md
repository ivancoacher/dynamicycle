---
id: "4402385511579"
title: "Understand Canada's anti-spam legislation"
source_url: "https://help.klaviyo.com/hc/en-us/articles/4402385511579-Understand-Canada-s-anti-spam-legislation"
...
Learn about the Canadian law that governs commercial electronic messages (such as email and SMS), which is the [Canadian Anti-Spam Legislation (CASL)](https://crtc.gc.ca/eng/internet/anti.htm).

When sending marketing messages, it’s important that you know about this law if you have Canadian recipients.

This information is ****not**** legal advice. Klaviyo recommends that you consult with your legal counsel to make sure that you comply with CASL and all other applicable laws in connection with your marketing activities.
...
- Your name (or business name) and contact information (valid mailing address and either an email address, phone number, or web address)
...
Because of the complexity involved with implicit consent, we recommend that you obtain explicit consent from all recipients you plan to send CEMs to. Explicit consent is required in order to send SMS and MMS messages using Klaviyo SMS.
...
- Send between 9 a.m. and 8 p.m. in the recipients’ local time (for SMS and direct messages); use[quiet hours for flows](https://help.klaviyo.com/hc/en-us/articles/4408737146651) to automatically prevent sending SMS outside of these times
...
- Do not overload recipients with too many messages; for instance, use [Smart Sending](https://help.klaviyo.com/hc/en-us/articles/115002779311-Smart-Sending-for-Flows#sms-smart-sending-window4) to limit how often someone can receive messages via a certain channel
...
## Sending to Canadian recipients using Klaviyo

When sending to Canadian recipients using Klaviyo, it’s important that you also comply with Klaviyo’s [Terms of Service](https://www.klaviyo.com/legal/terms-of-service) and [Acceptable Use Policy](https://www.klaviyo.com/legal/acceptable-use-policy), which, in certain cases, are more strict than CASL requirements. For example, in order to send SMS and MMS messages to recipients using Klaviyo SMS, you must obtain explicit consent.