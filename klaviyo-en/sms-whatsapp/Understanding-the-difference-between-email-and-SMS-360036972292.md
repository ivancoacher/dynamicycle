---
id: "360036972292"
title: "Understanding the difference between email and SMS"
source_url: "https://help.klaviyo.com/hc/en-us/articles/360036972292-Understanding-the-difference-between-email-and-SMS"
...
Your base plan in Klaviyo includes all profiles for your account as well as the ability to send emails. SMS is a separate, add-on plan that only deals with the number of [credits](https://help.klaviyo.com/hc/en-us/articles/13502982552347) you want.

For more information about these plans, see this article on [how Klaviyo billing works for email and SMS](https://klaviyo.zendesk.com/hc/en-us/articles/115000976672).
...
- SMS consent must always be optional (i.e., you cannot "force" someone to subscribe to SMS when they sign up for email)
...
When it comes to SMS, if someone reports you as spam to their phone carrier, you may face fines or heavy filtering.

## Availability

Email is available anywhere in the world. However, you can only send SMS messages to recipients in [certain countries](https://help.klaviyo.com/hc/en-us/articles/4402914866843).

If you’re both emailing and sending SMS messages within a flow, you can split the flow based on someone’s SMS consent at the beginning of the flow in order to maintain different experiences for your SMS opted-in customers and those who have not. For campaigns, you can [create a segment of SMS subscribers](https://help.klaviyo.com/hc/en-us/articles/360035800811) and send to only those profiles.
...
Except when using [branded sender ID](https://help.klaviyo.com/hc/en-us/articles/14953787622427), which can be customized to match your brand, someone receiving an SMS message will have no idea who your brand is unless you identify yourself. You’ll need to introduce your brand in the copy of your SMS or turn on the organization prefix so customers will know who is texting them.
...
However, you can adjust these windows. For instructions, head to our article on [conversion tracking](https://klaviyo.zendesk.com/hc/en-us/articles/115005248128).
...
All SMS messages in Klaviyo require consent, including those with transactional content. However, you can [collect consent for SMS transactional messages separately](https://help.klaviyo.com/hc/en-us/articles/31583129959195) from SMS marketing consent in Klaviyo.

## Metrics

Both email and SMS have associated metrics that correspond to customer actions with your brand. You can use these metrics to gain business insights, trigger flows, or personalize communication with your customers.

A key difference between the channels is that SMS doesn't track opens. The main reason is that this isn't a key metric for SMS like it is for email. Email open rates vary, and a good open rate is usually ~20%. On the other hand, almost all SMS messages (~98%) are read within minutes, so you can assume that if someone received the text, they likely saw it.

Head to our articles on [email metrics](https://klaviyo.zendesk.com/hc/en-us/articles/360036974872) and [SMS metrics](https://klaviyo.zendesk.com/hc/en-us/articles/360035345572) for the corresponding metrics within your account.

## Additional resources

- Check out [getting started with flows](https://help.klaviyo.com/hc/en-us/articles/115002774932)
- See our guide on [getting started with SMS](https://help.klaviyo.com/hc/en-us/articles/360035525311)
