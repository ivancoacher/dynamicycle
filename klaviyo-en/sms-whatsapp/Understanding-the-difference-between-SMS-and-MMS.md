---
id: 360041075091
title: "Understanding the difference between SMS and MMS"
...
Learn how SMS and MMS messages are similar and different as well as when and where to use them.
...
SMS with Klaviyo is currently available in [several countries](https://help.klaviyo.com/hc/en-us/articles/4402914866843), including the US, Canada, UK, Ireland, Australia, etc.
...
MMS is not available with Canadian short codes and Australian branded sender IDs.
...
- SMS messages can have up to 160 characters
  - 70 with an emoji or [special characters](https://help.klaviyo.com/hc/en-us/articles/17275332265627)
...
For instance, if you're using the variable to insert someone's first name (i.e., {{ person|lookup:"first\_name"|default:'there' }}), the estimated character count is 6. However, if someone's name is Alexandra, the actual count will be 9 characters.

![An SMS draft with only a dynamic content variable and no other text](https://klaviyo.zendesk.com/hc/article_attachments/33627678350875)

## When to use SMS vs. MMS

Use MMS sparingly. In general, MMS performs worse or equal to an SMS but costs more.

However, test what works for your brand. In some cases, sending an image or GIF can enhance the message, such as to make it more personal by showing more of your brand. MMS can also be useful for sending out information about a new product, giving you a stage to showcase it visually.
...
- Academy course: [Getting started with SMS](https://academy.klaviyo.com/getting-started-with-sms/1411601)
- Help Center:
  - [MMS image and GIF best practices](https://help.klaviyo.com/hc/en-us/articles/360041074911)
  - [Your strategic guide to Klaviyo SMS success](https://help.klaviyo.com/hc/en-us/articles/25220861016091)
