---
id: 26886941270171
title: "Short code application reference"
...
Learn more about the [benefits of short codes](https://help.klaviyo.com/hc/en-us/articles/14476797072795).
...
Once you fill out the form, **Incomplete** shows as the status for your short code. This status will change to **Active** when carriers approve the short code.  ![](https://klaviyo.zendesk.com/hc/article_attachments/28704487563675)
...
|  |  |  |  |  |
| --- | --- | --- | --- | --- |
|  | ****United States**** | ****Canada**** | ****United Kingdom**** | ****New Zealand**** |
| New short code | 8–12 weeks | 12–16 weeks | 12–16 weeks | 5–6 weeks |
| Migrating (porting) existing short code | 4–6 weeks | 12–16 weeks | 12–16 weeks | 4–6 weeks |

If you are approved and change your short code number, you are required to notify recipients that you are [changing numbers](https://help.klaviyo.com/hc/en-us/articles/4403980438555).
...
1. [Review prohibited content and spam mitigation policies.](#h_01J18EYCXJ366Z6K2M9B5MC3KK)
2. [Pick your top 3 vanity short codes](#h_01J18EYCXJV2H593XJNXE19FRV) (if applicable).
3. [Share company and contact information](#h_01J18EYCXJGRW2S7HK7T4BQ595).
4. [Determine SMS program service type(s)](#h_01J18EYCXJPK46A1M91DJCWRB9).
5. [Ensure your abandoned cart and sweepstakes programs are compliant](#h_01J18EYCXJ6PXS95H90T045ZJH) (US only).
6. [Create 3 example SMS messages](#h_01J18EYCXJYFED7XM2E3FT3NSA).
7. [Describe how customers can opt in to SMS](#h_01J18EYCXJTARGG9JQAX6AT7HX).
8. Have [SMS sign-up form](#h_01J18EYCXJT4PJ36FAANQ7MW85) example(s) ready.
   - Note: Klaviyo will create these for you.
9. [Check your disclosure language](#h_01J18EYCXJVMMPXGS7Q27CE7BJ).
10. [Estimate your monthly message volume](#h_01J18EYCXKNM4P6EACN3NCDTKS).
11. [Audit your terms of service (TOS) and privacy policy.](#h_01J18EYCXKBVAEYYW7Z1K78C11)
12. [Submit a letter of authorization](#h_01J18EYCXKV440ME34HVT7B7B8).
13. Recommended: [include any subscribe keywords you want to use](#h_01J18EYCXKJ3N7PVKMS5D8DYB3).
14. If migrating: [provide your short code lease](#h_01J18EYCXKR33M4G59JRNF4FQ9).
...
Of these, the only ones that may be allowed are [alcohol or firearms-related content](https://help.klaviyo.com/hc/en-us/articles/17252552814875), and only:

- When using age-gating
- In certain countries
- When using double opt-in

For all other industries, review your content to make sure that it isn’t [prohibited for SMS and MMS messages](https://help.klaviyo.com/hc/en-us/articles/4401822831771).
...
- [US short code registry](https://usshortcodes.com/)
- [CA short code registry](https://www.txt.ca/en/shortcode-search/)
- [UK short code registry](https://short-codes.com/)
- [NZ short code registry](https://www.tcf.org.nz/)
...
- Your name and email
- Klaviyo [account ID](https://help.klaviyo.com/hc/en-us/articles/115005062267)
...
- [Transactional](https://help.klaviyo.com/hc/en-us/articles/26024442679835)
...
Not interested in a US short code? Jump ahead to the next section on [creating example texts](#h_01J18EYCXJYFED7XM2E3FT3NSA).
...
- Get [explicit consent](https://help.klaviyo.com/hc/en-us/articles/4404203889947) to send cart abandonment SMS, sweepstake SMS, or both.
- Add disclosures about your cart abandonment/sweepstakes program to your mobile TOS and privacy policy
  - Note: we share examples in the [section on disclosure language](#h_01J18EYCXJVMMPXGS7Q27CE7BJ).
...
Due to the complexity of these program service types, carriers require additional information to ensure quality and legal compliance. If you use SMS for this purpose, review this article on [US guidelines for SMS cart abandonment flows](https://help.klaviyo.com/hc/en-us/articles/4404189657755).
...
- Brand name: Hey [first name]. We know you like [profile\_property], we just add a new variation. Get it now! [LINK] Reply HELP for help, STOP to opt out
...
Most countries require that customers give “[explicit](https://help.klaviyo.com/hc/en-us/articles/4404203889947), written consent” before receiving an automated text message. The customer must understand what they’re signing up for. Sending a text message without the customer’s prior consent is prohibited.

You cannot make consent to your SMS program a condition of purchase of property, goods, or services. Further, consent for another marketing channel (e.g., email) does not count as consent for SMS. Learn more [about collecting SMS consent](https://help.klaviyo.com/hc/en-us/articles/360035056972).
...
- Disclosure language that clearly explains your SMS program (see the [next section](#h_01J18EYCXJVMMPXGS7Q27CE7BJ) for details).
...
While Klaviyo provides an [example of disclosure language](https://help.klaviyo.com/hc/en-us/articles/11644128409371), the actual language may vary based on the country, your SMS program, etc.
...
Klaviyo can host your [mobile TOS](https://help.klaviyo.com/hc/en-us/articles/360049177511) for you.

While hosting isn’t available for privacy policies, you can follow the best practices and see example language for a [privacy policy](https://help.klaviyo.com/hc/en-us/articles/4404199571867). Further, if you were with another SMS provider, they may have hosted a privacy policy that you can look at.
...
This letter is to confirm that we, [Company Name], are giving permission to migrate a campaign for short code [Short code number], from [Current SMS Povider] to Klaviyo.
[Brand Representative]
[Signature]
[Title]
...
Carriers can take up several weeks, depending on the country, to review your application. These [short code review timelines](#h_01J18EYCXJEZA825HSWYEHASBJ) do not start as soon as you submit the application to Klaviyo, but only when Klaviyo submits the application to wireless carriers.
...
- Learn more best practices for creating an SMS [terms of service](https://help.klaviyo.com/hc/en-us/articles/360049177511) and [privacy policy](https://help.klaviyo.com/hc/en-us/articles/4404199571867)
- Find out the difference between [explicit and implicit consent](https://help.klaviyo.com/hc/en-us/articles/4404203889947)