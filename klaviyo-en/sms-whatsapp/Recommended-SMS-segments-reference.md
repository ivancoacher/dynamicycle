---
id: 360047879512
title: "Recommended SMS segments reference"
...
Learn how to create segments that will level up your SMS marketing strategy. Segmentation allows you to better understand your audience and send targeted messages in Klaviyo.

### Why are these SMS segments recommended?
...
![](https://fast.wistia.com/embed/medias/rnz47vfakn/swatch)
...
![The all SMS subscribers includes 1 condition: someone can receive SMS marketing](https://klaviyo.zendesk.com/hc/article_attachments/28704477227931)

## Highly engaged SMS segment

Similar to an [engaged email segment](https://klaviyo.zendesk.com/hc/en-us/articles/115000200072), an engaged SMS segment allows you to target those who regularly interact with your content.
...
![track A.jpg](https://klaviyo.zendesk.com/hc/article_attachments/28704485385883)

You can also use engagement tracks to create a sending schedule for your SMS content. For more information around measuring engagement and sending to different tiers, read our article on how to [create a sending schedule based on SMS engagement](https://klaviyo.zendesk.com/hc/en-us/articles/360044556071).
...
![A segment of subscribers that prefer SMS over email](https://klaviyo.zendesk.com/hc/article_attachments/28704477211291)

## SMS VIP segment

An SMS VIP segment allows you to hone in on your most valuable customers who have opted into SMS marketing. Send this group exclusive deals and promotions, and let them know that you appreciate their ongoing support. You can either build this from scratch or [clone](https://klaviyo.zendesk.com/hc/en-us/articles/115005238248) an existing email [VIP segment](https://klaviyo.zendesk.com/hc/en-us/articles/115005065707) and add new conditions around SMS.
...
![A segment of VIP purchasers who are susbcribed to SMS](https://klaviyo.zendesk.com/hc/article_attachments/28704477220635)

For more information on how to segment and target VIP customers, head to our [Guide to running a VIP program](https://academy.klaviyo.com/running-a-vip-program).

## High-intent SMS shoppers
...
![high-intent.png](https://klaviyo.zendesk.com/hc/article_attachments/28704485369115)
...
![SMS location segment.jpg](https://klaviyo.zendesk.com/hc/article_attachments/28704477225243)

You can also segment your SMS subscribers based on their phone numbers's country code. For details, check out this article on [segmenting SMS subscribers by country](https://help.klaviyo.com/hc/en-us/articles/4402954226459).

## SMS budget shoppers

An SMS Budget Shoppers segment includes those who engage with your SMS messaging and have purchased from your store. However, their shopping behavior shows that they are either thrifty or frequently purchase during sales. You can create a segment around this behavior using [customer lifetime value (CLV)](https://help.klaviyo.com/hc/en-us/articles/360013201072) or previous purchase history. Then target these segments primarily with sale messages to encourage another conversion. The example below targets any SMS subscriber whose predicted CLV is at most $10; however, the amount you deem as a low CLV will vary depending on your business and pricing.

![A segment of SMS subscribers with low predicted customer lifetime value](https://klaviyo.zendesk.com/hc/article_attachments/28704485356571)

## SMS marketing preference segment

In some cases, you may ask SMS subscribers for the exact content that they want to receive from you. They may opt-in to get messaging around events, flash sales, or new products. You can make each of these a [profile property](https://klaviyo.zendesk.com/hc/en-us/articles/115005074627) and then create segments for subscribers who only want to hear about specific announcements via SMS. In the example below, this segment will include those who want to hear about product launches via SMS.

![A segment of profiles that have a certain profile property](https://klaviyo.zendesk.com/hc/article_attachments/28704485359643)
...
- This segment is not available with [branded sender IDs](https://help.klaviyo.com/hc/en-us/articles/6637671573403), as these numbers cannot receive SMS messages.
- You may want to include alternate or misspelling of the word you want for the segment (as shown below).

![Segment of profiles that have sent the keyword JOIN](https://klaviyo.zendesk.com/hc/article_attachments/33331385281435)
...
- Basing it on the opt-in keyword someone used
  - This includes both [custom subscribe keywords](https://help.klaviyo.com/hc/en-us/articles/360050384091) and the opt-in compliance keyword

|  |  |
| --- | --- |
| Using a profile property | ![](https://cdn.sanity.io/images/6ct6b26e/help-center-prod/3093b555f044b765e31b257cab760853b06e2dfd-2480x250.png) |
| Using the opt-in keyword | ![](https://cdn.sanity.io/images/6ct6b26e/help-center-prod/c675d31426e4f58433f3f476f9087b256e96dbd1-2488x410.png) |
...
![Has not received virtual contact card](https://klaviyo.zendesk.com/hc/article_attachments/28704477223707)