---
id: 360003211651
title: "Frequently asked questions about GDPR"
source_url: "https://klaviyo.zendesk.com/hc/en-us/articles/360003211651-Frequently-asked-questions-about-GDPR"
section: "GDPR and CCPA"
category: "Deliverability & compliance"
category_slug: "deliverability-compliance"
klaviyo_updated: "2026-05-11T10:59:43Z"
language: en
---
...
GDPR stands for the General Data Protection Regulation which is a law enacted by the European Commission in 2016 that went into effect on May 25, 2018. It’s designed to protect the privacy of all EU citizens, including when those citizens engage with businesses located outside the European Union, by imposing regulations around personal data. For more information on GDPR, [check out our blog series](https://www.klaviyo.com/blog/gdpr-for-ecommerce).
...
Yes. The GDPR recognizes a number of legal mechanisms for transferring data out of the EU. Following the invalidation of the EU-US Privacy Shield framework, Klaviyo has incorporated the European Commission's Standard Contractual Clauses into our [Data Protection Addendum](https://www.klaviyo.com/privacy/dpa), which is incorporated into our [Terms of Service](https://www.klaviyo.com/legal/terms-of-service). We recommend consulting your legal team to determine the appropriate transfer mechanism for any transfers of data your organization may make.
...
In addition to using [double opt-in](https://help.klaviyo.com/hc/en-us/articles/115005251108-Overview-of-the-Double-Opt-In-Process), you are required to retain the language that was presented to the consumer in the form, email, or webpage where they provided consent. So, you will have to be able to produce both the time/date that they consented and exactly what they consented to.
...
Klaviyo provides [GDPR compliant forms](https://help.klaviyo.com/hc/en-us/articles/360003536031-Collect-GDPR-Compliant-Consent) with multiple checkboxes, allowing for granular consent (i.e. separate consent for email marketing and Facebook marketing).
...
Information about the data that we process and the measures we take to protect it can be found in our [Data Processing Addendum (DPA)](https://www.klaviyo.com/privacy/dpa). Security measures are specifically outlined in Attachment 2 to the Addendum. You can also read our entire [Terms of Service](https://www.klaviyo.com/terms-of-service).
...
Not necessarily. The specific requirements may vary country to country, so we recommend consulting your legal team about country-specific requirements, but Klaviyo provides default [opt-in language](https://help.klaviyo.com/hc/en-us/articles/115005239028-Klaviyo-s-Support-for-Multiple-Languages#changing-sign-up-form-opt-in-text3) in several languages.
...
Using Google Fonts can cause GDPR compliance issues as Google’s server needs the receiver’s IP address to deliver fonts. According to the GDPR, an IP address qualifies as personal information, which can be used to identify the user. Note that by including Google Fonts in your font library, you are deemed to be using Google Fonts.

As an alternative to Google Fonts, Klaviyo provides a selection of fonts hosted in Klaviyo for use in your sign-up forms, consent pages, and emails. These do not require the receiver's IP.

See the [list of Klaviyo-hosted fonts](https://help.klaviyo.com/hc/en-us/articles/14780233854363) and [learn more about Google Fonts.](https://community.klaviyo.com/news-announcements-51/klaviyo-hosted-fonts-alternative-to-google-fonts-7981)

## Additional Resources

- [Collect GDPR Compliant Consent](https://klaviyo.zendesk.com/hc/en-us/articles/360003536031)
- [Best Practices for Complying with Data Privacy Laws](https://klaviyo.zendesk.com/hc/en-us/articles/360038973652)
- [Uploading and Segmenting with Consent](https://klaviyo.zendesk.com/hc/en-us/articles/360043841811)
- [Consent in Profiles](https://klaviyo.zendesk.com/hc/en-us/articles/360037101072)