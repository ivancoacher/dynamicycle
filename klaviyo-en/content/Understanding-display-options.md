---
id: 4408802299547
title: "Understanding display options"
...
If a block or section is set to desktop-only, changes made to that content will not impact the mobile version of the email, and vice versa.

### Show/hide logic

Individual blocks and entire sections can be shown to or hidden from recipients who meet certain criteria you set.

As an example, consider a company that sells gardening supplies. They’ve used a form to ask their customers if they are more interested in flower gardens, vegetable gardens, or both. When they send a campaign, they can use show/hide logic to show flower seed packets to those interested in flower gardening, and to show vegetable seeds to vegetable gardeners.

![A show/hide condition](https://klaviyo.zendesk.com/hc/article_attachments/30443732700827)
...
Learn how to [show or hide template blocks and sections](https://help.klaviyo.com/hc/en-us/articles/115005258208) based on a recipient’s profile information or event details.

### Content repeat

Individual blocks and entire sections can be set to repeat based on profile or event data. For example, in an order confirmation flow, the **Content Repeat** feature can be used to display a block for each item in the order. Within the block or section, dynamic variables can be added to display details about each specific item.

![A content repeat rule](https://klaviyo.zendesk.com/hc/article_attachments/30443732710299)

Learn how to [set up a section repeat](https://help.klaviyo.com/hc/en-us/articles/115005083467).