---
id: "115000807711"
title: "How to add columns to an email"
source_url: "https://help.klaviyo.com/hc/en-us/articles/115000807711-How-to-add-columns-to-an-email"
...
## When to use a split block, columns, or a table
...
## Add a split block to an email

To add a split block to an email:

1. Drag a **Split** block into your template.
2. Adjust the **Layout** percentages to customize the width of the 2 columns.
3. In the **Content** section, choose whether each side of your split block should contain text or an image.
4. Click the icons under **Column selector** to switch between the columns.
...
1. Drag in the **Columns** option under **Layout** to create columns in your email.
2. Choose your desired layout from the options in the modal.
3. Drag blocks of any type into your columns.
...
![An example of a column with text and buttons on the left, and an image on the right](https://klaviyo.zendesk.com/hc/article_attachments/28720621027995)

Additionally, when a mobile browser opens the email, the columns will stack on top of each other, with the left side stacking on top of the right. If you do not want your columns stacked on mobile, [opt for using a table block](https://help.klaviyo.com/hc/en-us/articles/115000807711#table-block3).

## Add a table block to an email
...
For more information on email design, check out our [course on email design](https://academy.klaviyo.com/get-started-with-email-design)

## Additional resources

- [How to add a first name to an email or SMS](https://klaviyo.zendesk.com/hc/en-us/articles/11613154130843)
- [Accessibility in emails and forms best practice reference](https://klaviyo.zendesk.com/hc/en-us/articles/360034711931)