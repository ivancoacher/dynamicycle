---
id: "32201419926939"
title: "How to use a header bar block in an email"
source_url: "https://help.klaviyo.com/hc/en-us/articles/32201419926939-How-to-use-a-header-bar-block-in-an-email"
...
- ****Desktop layout options****
  ...
  - Links and buttons only
    ![](https://klaviyo.zendesk.com/hc/article_attachments/32201419896731)
- ****Mobile layout options****
  ...
  - Stacked links and buttons only
    ![](https://klaviyo.zendesk.com/hc/article_attachments/32201388542747)
...
1. Within an email template, drag a ****Header bar**** block into the canvas.
   ![](https://klaviyo.zendesk.com/hc/article_attachments/32201388543387)
...
3. Use the dropdown arrow  icon to see each link’s details and edit its link text and URL.
   ![](https://klaviyo.zendesk.com/hc/article_attachments/32201388545691)
   1. To save space on mobile, consider selecting ****Desktop only**** for any non-essential links.
      ![](https://klaviyo.zendesk.com/hc/article_attachments/32201419910043)
4. Use the ****Add link**** or ****Add image**** buttons to add additional links or content.
   ![](https://klaviyo.zendesk.com/hc/article_attachments/32201419911835)
...
![](https://klaviyo.zendesk.com/hc/article_attachments/32201419914395)

Learn more about [universal and saved content](https://help.klaviyo.com/hc/en-us/articles/115005413888).

## Header bar block inbox considerations

Depending on the recipient’s inbox, the header bar (or email as a whole) may appear with slight differences. To see how your email will appear in different inboxes, consider using a tool like [Email on Acid](https://www.emailonacid.com/).

### Header bar blocks and Gmail clipping

Header bar blocks are code-heavy, which means they increase the overall code weight of your email. In messages that contain a large amount of other content, this could lead to [Gmail clipping](https://help.klaviyo.com/hc/en-us/articles/115000591251).
...
- [How to use a text block in an email](https://klaviyo.zendesk.com/hc/en-us/articles/32200923751195)
