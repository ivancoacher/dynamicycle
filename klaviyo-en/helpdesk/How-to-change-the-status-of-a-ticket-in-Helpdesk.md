---
id: 4405329314331
title: "How to change the status of a ticket in Helpdesk"
...
![Screenshot 2025-09-23 at 3.16.42 PM.png](https://klaviyo.zendesk.com/hc/article_attachments/41371897243803)
...
5. In the resulting modal, select a snooze duration.
6. Click ****Confirm**** to snooze the ticket.

   Once the snooze duration passes, the ticket re-appears as an **Open** message, either in the **My Inbox** view or the **Unassigned** view, depending on the [ticket's assignment](https://klaviyo.zendesk.com/hc/en-us/articles/35970894978075).

   If you want to view your snoozed messages:
7. Select the ****All tickets**** view.
8. Select the message status filter in one of your Inbox ticket views. By default, this is set to **Open**.
9. Choose ****Snoozed****.
