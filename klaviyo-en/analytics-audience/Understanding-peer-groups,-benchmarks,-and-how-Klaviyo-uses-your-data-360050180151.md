---
id: "360050180151"
title: "Understanding peer groups, benchmarks, and how Klaviyo uses your data"
source_url: "https://help.klaviyo.com/hc/en-us/articles/360050180151-Understanding-peer-groups-benchmarks-and-how-Klaviyo-uses-your-data"
...
Learn about peer groups and industry benchmarks in Klaviyo, including what they are and how to understand the information they provide.

[Klaviyo benchmarks](https://help.klaviyo.com/hc/en-us/articles/360050110072) are formulated using peer groups and industry benchmarks. In this guide, you will learn what both of these entail and how to understand the information they provide so that you can learn from benchmarking results and expand your business.

Klaviyo decides your peer groups or industry benchmarks by using information that is stored on your [organization’s contact information](https://www.klaviyo.com/account#company-tab). It is important to make sure this information is up to date and best reflects the nature of your business. Head to [How to update your industry and vertical in Klaviyo](https://help.klaviyo.com/hc/en-us/articles/360050696531) for more information.
...
![Example message at the top of benchmarks pages showing your peer group at top and your performance against these peers ](https://klaviyo.zendesk.com/hc/article_attachments/28717987150363)
...
Peer groups allow you to compare your performance to similar companies. In each of the benchmark pages and data display options (tables, graph, and line charts), you will see how you compare to different percentiles in your peer group. The example below shows a graph view of peer group data in relation to a sample business on the business performance page. ![Example of bar graphs on the Business Performance page showing s bar for account data, peers, and industry ](https://klaviyo.zendesk.com/hc/article_attachments/28717987153947)
...
Note that if you have updated your industry in Klaviyo, when you navigate to ****Benchmarks > How we choose your peer group****, you will see information around what industries your peers are in, as shown in the first image [above](https://help.klaviyo.com/hc/en-us/articles/360050180151-Understanding-Peer-Groups-and-Industry-Benchmarks#h_01EPW4WCM9DCC8RKSKAFA48PT7). If the wrong industry is associated with your account, you can edit this directly from the sentence above the table by clicking ****Change Industry****. Once corrected, Klaviyo will generate benchmarks that better serve your brand.
...
Note that your personal information is private and will not be shared. We do not sell any of this data and never reference any customers when using aggregated data or present it in such a way that it could be tied back to a customer. When you create an account and agree to the [Klaviyo Terms of Service](https://www.klaviyo.com/legal/terms-of-service), you agree to allow us to aggregate and use your data in this way.

## Additional resources

- [How to update your industry and vertical](https://klaviyo.zendesk.com/hc/en-us/articles/360050696531)
- [How to use benchmarks reports in custom reports](https://klaviyo.zendesk.com/hc/en-us/articles/360050110072)
