---
id: 41537373957787
title: "How to localize Customer Hub for multi-language stores"
source_url: "https://klaviyo.zendesk.com/hc/en-us/articles/41537373957787-How-to-localize-Customer-Hub-for-multi-language-stores"
section: "Getting started with Customer Hub"
category: "Customer Hub"
category_slug: "customer-hub"
klaviyo_updated: "2026-05-22T14:33:14Z"
language: en
---

## You will learn

Learn how to configure Customer Hub for international audiences, including how automatic system translations work and how to manually translate your custom content.

If you also sell in multiple markets with market-specific inventories, currencies, etc., please refer to [how to use Customer Hub with Shopify Markets](https://help.klaviyo.com/hc/en-us/articles/44768355991195).
...
- French (France) (Français) — fr-FR
- German (Germany) (Deutsch) — de-DE
- Italian (Italy) (Italiano) — it-IT
- Spanish (Spain) (Español — España) — es-ES
- Portuguese (Brazil) (Português — Brasil) — pt-BR
- Korean (South Korea) (한국어) — ko-KR
...
- Norwegian Bokmål (Norway) (Norsk bokmål) — nb-NO
- Polish (Poland) (Polski) — pl-PL
- Spanish (Latin America) (Español — Latinoamérica) — es-LA
...
![](https://klaviyo.zendesk.com/hc/article_attachments/41537373955739)
...
2. Click on the "****translations****" button in the top bar.
   ![](https://klaviyo.zendesk.com/hc/article_attachments/44768078106267)
3. In the translations UI, you'll see all the custom text content you can edit
   ![](https://klaviyo.zendesk.com/hc/article_attachments/44768078109211)
4. Select the language you wish to edit (e.g., ****French****). Note that this is also where you add / remove languages you want for Customer Hub.
   ![](https://klaviyo.zendesk.com/hc/article_attachments/44768097104795)
...
2. Click on "review translations" on the banner.
   ![](https://klaviyo.zendesk.com/hc/article_attachments/44768097106075)
3. The process will step you through each language, highlighting which text strings changed, and you can either manually update them, or click "update translations" to use AI translation.
   ![](https://klaviyo.zendesk.com/hc/article_attachments/44768097107611)
...
![](https://klaviyo.zendesk.com/hc/article_attachments/44768097108891)
...
Within the Klaviyo app, Customer Hub supports the same languages as the rest of the Klaviyo platform. You can learn more [here](https://help.klaviyo.com/hc/en-us/articles/25956849989531).