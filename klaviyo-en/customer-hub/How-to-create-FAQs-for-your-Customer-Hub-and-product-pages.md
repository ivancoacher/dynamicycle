---
id: 36400427885979
title: "How to create FAQs for your Customer Hub and product pages"
...
This guide covers how to enable FAQs for your site’s Customer Hub interface. Before proceeding, ensure that you have the [Customer Hub feature enabled in Klaviyo](https://klaviyo.com/try-service).
...
1. ****Customer Hub****
   ...
   - ****Web chat not enabled**** (right image)
     ...
     |  |  |
     | --- | --- |
     | ![An FAQ open in the Chat tab of the Customer Hub interface.](https://klaviyo.zendesk.com/hc/article_attachments/36400406824347) | ![An FAQ open in the FAQ tab of the Customer Hub interface. ](https://klaviyo.zendesk.com/hc/article_attachments/36400427848475) |
2. ****Product Detail Pages****
   - (Optional) You can surface up to 3 FAQs beneath products on your site’s product detail pages. When a customer clicks a question, the Customer Hub interface opens with the answer.
     ![Three example FAQs showing beneath a product on a product details page.](https://klaviyo.zendesk.com/hc/article_attachments/36400406834971)
...
2. Click ****Design****.
   ![](https://klaviyo.zendesk.com/hc/article_attachments/43171036393243)
3. Find the ****FAQ**** option in the editor canvas near the top, or go to <https://www.klaviyo.com/customer-hub/design?view=faq>
   1. ![](https://klaviyo.zendesk.com/hc/article_attachments/43171036394651)
4. Click ****Create FAQ****.
5. Fill in your FAQ’s details:
   - ****Name****
     ...
     You cannot change an FAQ's name after creating it. This is because Klaviyo uses the FAQ name to track and filter customer interactions with FAQs (e.g., **Customer Hub clicked on FAQ**events). Use a clear, relevant name for each FAQ to ensure accurate reporting.
   - ****Question****
...
6. Click ****Create**** to publish your FAQ in the Customer Hub interface.
   ![The FAQ creation page in Klaviyo.](https://klaviyo.zendesk.com/hc/article_attachments/36400406837659)
...
![](https://klaviyo.zendesk.com/hc/article_attachments/43171036395931)
...
2. Doing so launches your Shopify theme editor in a new window, showing a modal indicating that the **Klaviyo FAQs** app block was added to your default product page template.
   ![A default product template in Klaviyo showing the Klaviyo FAQs app added.](https://klaviyo.zendesk.com/hc/article_attachments/36400427862171)
...
5. Return to Klaviyo and refresh the page. The **Display questions on product detail pages** setting now appears.
   ![The Display questions on product detail pages menu on the FAQs tab in Klaviyo showing one FAQ selected to display.](https://klaviyo.zendesk.com/hc/article_attachments/36400406844571)
...
4. Click the ****Select FAQs to display**** dropdown and select or deselect the questions you want to show. You can display up to 3 FAQs.
   ![The Display FAQs on product detail pages menu in Klaviyo showing the selection dropdown open and one FAQ selected.](https://klaviyo.zendesk.com/hc/article_attachments/36400427870619)
...
4. Next to the FAQ you’d like to modify, select the additional options (3 dots) menu, then select ****Edit****.
   ![](https://klaviyo.zendesk.com/hc/article_attachments/43171057343899)
...
- [Getting started with Klaviyo's Customer Agent](https://klaviyo.zendesk.com/hc/en-us/articles/37659268052635)
