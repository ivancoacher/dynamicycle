---
id: "16685026123035"
title: "Best practices for collecting customer reviews"
source_url: "https://help.klaviyo.com/hc/en-us/articles/16685026123035-Best-practices-for-collecting-customer-reviews"
...
Learn some recommended best practices for enabling transparency, fairness, and compliance with certain regulations that govern collecting and managing reviews.
...
If suspicious or fraudulent activity is identified, Klaviyo may suspend accounts account while our team investigates. Following the investigation, we will determine the appropriate action, which may include restoring or disabling access to the services depending on the findings.

The regulations governing reviews include:

- ****United States****
  The Federal Trade Commission (FTC) Act including FTC's [Guides Concerning Use of Endorsements and Testimonials in Advertising](https://www.ecfr.gov/current/title-16/chapter-I/subchapter-B/part-255) (Endorsement Guides) and the [Consumer Review Fairness Act](https://www.ftc.gov/business-guidance/resources/consumer-review-fairness-act-what-businesses-need-know) (CRFA). The FTC also has published [business guidance resources](https://www.ftc.gov/business-guidance/advertising-marketing/endorsements-influencers-reviews) on reviews.
- ****EU****
  The Enforcement and Modernisation Directive (2019/2161) (the [Omnibus Directive)](https://eur-lex.europa.eu/eli/dir/2019/2161).
- ****Australia****
  [Australian Consumer Law](https://consumer.gov.au/)
  The Australian Competition and Consumer Commission (ACCC) has published [business resources on reviews](https://www.accc.gov.au/business/advertising-and-promotions/online-product-and-service-reviews).
...
- Generally, a review may be rejected or removed for the following reasons:
  - It contains confidential or private information (e.g., a person’s financial, medical, phone number, email address, or home address, or personnel file information or a company’s trade secrets).
  - It presents a conflict of interest (e.g., written by a business owner, employee, or affiliated party).
  ...
  - It includes URLs, links to other websites or stores, or content promoting unrelated products or services.
  - It promotes or references illegal activity, such as drug use, weapons, or other unlawful content.
  - It contains copyrighted or plagiarized material, including text or media copied from another source without permission.
  - It involves impersonation or is submitted by someone pretending to be another individual or customer.
