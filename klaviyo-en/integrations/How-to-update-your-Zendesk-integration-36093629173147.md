---
id: "36093629173147"
title: "How to update your Zendesk integration"
source_url: "https://help.klaviyo.com/hc/en-us/articles/36093629173147-How-to-update-your-Zendesk-integration"
section: "Zendesk"
...
Looking to integrate for the first time? Head to [Getting started with Zendesk](https://help.klaviyo.com/hc/en-us/articles/115005253728).
...
3. On the next page, click ****Update version****.
   ![](https://klaviyo.zendesk.com/hc/article_attachments/36212390741659)
...
6. Under **Tickets,** choose whether you want to sync Zendesk **Opened** and **Resolved** ticket metrics from all brands, or specific brands. If you select **Specific brands**, you’ll be prompted to choose the brands you’d like from a dropdown.
   ![](https://klaviyo.zendesk.com/hc/article_attachments/36212407244315)
7. If you want to reply to inbound SMS messages via Zendesk, check the box next to ****Sync SMS conversations****. If you’d like these inbound messages to create Zendesk tickets under a specific brand, select the brand from the dropdown.
   ![](https://klaviyo.zendesk.com/hc/article_attachments/36212390753051)
