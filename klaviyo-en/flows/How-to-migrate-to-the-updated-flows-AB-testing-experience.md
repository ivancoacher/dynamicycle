---
id: 6960265887259
title: "How to migrate to the updated flows A/B testing experience"
...
Learn how to update your existing flows' A/B tests to Klaviyo’s updated and improved A/B testing experience. You'll be able to create more comprehensive, data-backed A/B tests with automatic winner selection and easier access to your historical testing data.
...
For details on how to set up new A/B tests using the updated version, please see our article on [how to A/B test a flow email using the new A/B testing experience.](https://help.klaviyo.com/hc/en-us/articles/6960371049115)
...
![A message will appear above the flows list with information about the updated A/B testing experience.](https://klaviyo.zendesk.com/hc/article_attachments/28704477734299)
...
2. A modal will appear, informing you how many A/B tests in your account are still running and are using the old version of A/B testing. If you’d like, you can manually end existing tests – choosing a winner by changing the percentage of one of one of the variations to 100%.
   ...
   ![A modal will present you with 2 options to update existing tests.](https://klaviyo.zendesk.com/hc/article_attachments/28704485878171)
...
4. Once you have chosen an option, another modal will appear asking you to confirm your selection. Click the ****Update Now**** button to confirm.
   ...
   ![A modal will appear asking you to confirm that you want to update your existing tests.](https://klaviyo.zendesk.com/hc/article_attachments/28704477736219)
5. Now that you have successfully migrated to the updated A/B testing version, you can follow the steps in our guide on how to [How to A/B test a flow email using the updated A/B testing experience](https://help.klaviyo.com/hc/en-us/articles/6960371049115).

## Additional resources

- [A/B testing a flow branch](https://help.klaviyo.com/hc/en-us/articles/360049849432)
