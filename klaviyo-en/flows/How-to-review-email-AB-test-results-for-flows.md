---
id: 9360405808027
title: "How to review email A/B test results for flows"
...
Learn how to review A/B test results for flow messages and what each of the indicators on the results page mean.
...
The option to view test results will only appear for tests that have been published - this includes tests that are currently running and those that have completed. To learn more about creating and publishing a test, please see our article on [how to A/B test a flow email](https://help.klaviyo.com/hc/en-us/articles/6960371049115).
...
2. In the right details sidebar, click ****View Test****.
   ![statistical significant.jpg](https://klaviyo.zendesk.com/hc/article_attachments/28704477913371)

   You will automatically be taken to the **A/B test results** tab, where you can see show the results for the current or most recent A/B test.

   If you want to view the results for previous tests, open the test name dropdown on the top left of the page and choose the name of a previous test to view its results, as shown below.

   ![The names of past A/B tests found on the A/B test results page](https://klaviyo.zendesk.com/hc/article_attachments/28704486042651)

   The results page is broken into two parts:
3. Test Overview
4. Variations

![The A/B test results page with the overview and variations sections](https://klaviyo.zendesk.com/hc/article_attachments/28704477906843)
...
- ****Current Weights****
  ...
  ![The overview section for a currently running test](https://klaviyo.zendesk.com/hc/article_attachments/28704477910171)
...
![The overview section for a completed test](https://klaviyo.zendesk.com/hc/article_attachments/28704486044955)
...
![Chart displaying Click Rate over time](https://klaviyo.zendesk.com/hc/article_attachments/28704486045979)
...
![Variations sections showing metrics for 2 variations](https://klaviyo.zendesk.com/hc/article_attachments/28704477911195)